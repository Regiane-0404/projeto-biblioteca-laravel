                        ...
                        <div class="card-body">
                            ...
                            <div class="space-y-6 mt-6">
                                <div>
                                    ...
                                    <p class="text-base-content/80 text-lg">{{ $livro->editora->nome ?? 'Não informado' }}</p>
                                </div>
                                <div>
                                    <h3 class="font-semibold text-base-content text-lg mb-2">✍️ {{ Str::plural('Autor', $livro->autores->count()) }}</h3>
                                    <p class="text-base-content/80 text-lg">{{ $livro->autores->pluck('nome')->join(', ') ?: 'Nenhum autor associado' }}</p>
                                </div>
