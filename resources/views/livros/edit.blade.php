                            ...
                            <div class="space-y-4">
                                    ...
                                    <div class="form-control">
                                        ...
                                        <div class="flex items-center gap-4">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-xs text-base-content/60">Selecione uma nova imagem abaixo para substituir</p>
                                            </div>
                                        </div>
                                    </div>
                                @endif
                                ...
                                <div class="form-control">
                                    <label class="label" for="imagem_capa">
                                        <span class="label-text font-semibold">🖼️ {{ $livro->imagem_capa ? 'Nova Capa' : 'Capa do Livro' }}</span>
                                    </label>
                                    <input 
                                        type="file" 
                                        id="imagem_capa"
