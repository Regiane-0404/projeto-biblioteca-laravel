                    ...
                    <form method="POST" action="{{ route('livros.update', $livro) }}" enctype="multipart/form-data">
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="form-control">
                                    ...
                                    <input type="text" id="nome" name="nome"
                                        ...
                                        value="{{ old('nome', $livro->nome) }}" placeholder="Ex: Dom Casmurro"
                                        required />
                                    @error('nome')
                                        <label class="label">
                                ...
                                <div class="form-control">
                                    ...
                                    <input type="text" id="isbn" name="isbn"
                                        ...
                                        value="{{ old('isbn', $livro->isbn) }}" placeholder="Ex: 978-85-250-0000-0"
                                        required />
                                    @error('isbn')
                                        <label class="label">
                                            <span class="label-text-alt text-error">{{ $message }}</span>
                                ...
                                <div class="form-control">
                                    ...
                                    <input type="number" id="preco" name="preco"
                                        ...
                                        value="{{ old('preco', $livro->preco) }}" placeholder="Ex: 15.90"
                                ...
                                {{-- ============================================= --}}
                                {{-- CAMPO DE QUANTIDADE EM ESTOQUE (EMPRÉSTIMO) --}}
                                {{-- ============================================= --}}
                                <div class="form-control">
                                    <label class="label"><span class="label-text">Quantidade em Estoque
                                            (Empréstimo)</span></label>
                                ...
                                <div class="form-control">
                                    ...
                                    <input type="number" name="quantidade_venda"
                                        value="{{ old('quantidade_venda', $livro->quantidade_venda) }}"
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="form-control">
                                    ...
                                    <div class="grid grid-cols-1 gap-2 max-h-48 overflow-y-auto border rounded-lg p-3">
                                        @php
                                            $livroAutores = old('autores', $livro->autores->pluck('id')->toArray());
                                        @endphp
                                        @foreach ($autores as $autor)
                                            <label class="cursor-pointer label justify-start gap-3">
                                                <input type="checkbox" name="autores[]" value="{{ $autor->id }}"
                                                    class="checkbox checkbox-primary"
                                                    {{ in_array($autor->id, $livroAutores) ? 'checked' : '' }} />
                                ...
                                @if ($livro->imagem_capa)
                                    <div class="form-control">
                                        <label class="label">
                                            <span class="label-text font-semibold">📸 Capa Atual</span>
                                        </label>
                                        <div class="flex items-center gap-4">
                                            <img src="{{ asset('storage/' . $livro->imagem_capa) }}" alt="Capa atual"
                                                class="w-20 h-20 object-cover rounded-lg shadow" />
                                            <div>
                                                <p class="text-sm">Capa atual do livro</p>
                                                <p class="text-xs text-base-content/60">Selecione uma nova imagem
                                                    abaixo para substituir</p>
                                            </div>
                                        </div>
                                    </div>
                                @endif
                                ...
                                <div class="form-control">
                                    <label class="label" for="imagem_capa">
                                        <span class="label-text font-semibold">🖼️
                                            {{ $livro->imagem_capa ? 'Nova Capa' : 'Capa do Livro' }}</span>
                                    </label>
                        ...
                        <div class="form-control mt-6">
                            ...
                            <textarea id="bibliografia" name="bibliografia"
                                ...
                                placeholder="Breve descrição do livro, sinopse, etc...">{{ old('bibliografia', $livro->bibliografia) }}</textarea>
                            @error('bibliografia')
                                <label class="label">
                                    <span class="label-text-alt text-error">{{ $message }}</span>
                                </label>
