            ...
            <div class="card bg-base-100 shadow-lg">
                <div class="card-body">
                    ...
                    <form action="{{ route('users.update', $user) }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                <div class="form-control mb-4">
                                    ...
                                    >
                                        <option value="cidadao" {{ old('role', $user->role) === 'cidadao' ? 'selected' : '' }}>
                                    ...
                                    @if ($user->id === auth()->id())
                                        ...
                                        <label class="label">
                                            <span class="label-text-alt text-warning">⚠️ Você não pode alterar seu próprio perfil</span>
                                        </label>
                                    @endif
                                ...
                                <div class="form-control mb-4">
                                    ...
                                    <div class="form-control">
                                        ...
                                        @if ($user->id === auth()->id())
                                            ...
                                            <label class="label">
                                                <span class="label-text-alt text-warning">⚠️ Você não pode inativar sua própria conta</span>
                                            </label>
                                        @endif
                                    </div>
                                </div>
                        ...
                        <div class="divider">Alterar Senha (deixe em branco para manter atual)</div>
                        ...
                        <div class="alert alert-info mb-6">
                            ...
                            <ul class="list-disc list-inside mt-2">
                                ...
                                @if ($user->requisicaesAtivas->count() > 0)
                                    <li><strong>Requisições ativas:</strong> {{ $user->requisicaesAtivas->count() }}</li>
                                @endif
                            </ul>
                        </div>
