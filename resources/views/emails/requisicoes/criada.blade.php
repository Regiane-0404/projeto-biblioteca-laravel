<x-mail::message>
    ...
    A sua requisição para o livro abaixo foi registada com sucesso e está agora pendente de aprovação por um dos nossos
    administradores.
    ...
    **Data Prevista para Devolução:** {{ $requisicao->data_fim_prevista->format('d/m/Y') }}
    ...
    <x-mail::button :url="route('/requisicoes')">
