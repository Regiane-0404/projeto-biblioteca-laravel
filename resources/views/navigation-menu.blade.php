            ...
            <div class="dropdown lg:hidden">
                ...
                <ul tabindex="0"
                    ...
                    @auth
                        ...
                        @if (auth()->user()->role === 'admin')
                            {{-- ============================================== --}}
                            {{-- == INÍCIO DO NOVO MENU DE ENCOMENDAS (MOBILE) == --}}
                            {{-- ============================================== --}}
                            <li><a>🚚 Gestão de Encomendas</a>
                                <ul class="p-2">
                                    <li><a href="{{ route('admin.encomendas.index') }}">Ver Lista</a></li>
                                </ul>
                            </li>
                            {{-- ============================================== --}}
                ...
                @auth
                    ...
                    <li>
                        <details>
                            ...
                            <ul class="p-2 bg-base-100 rounded-t-none z-[1]">
                                <li><a href="{{ route('requisicoes.index') }}">📋
                                        {{ auth()->user()->role === 'admin' ? 'Ver Todas' : 'Minhas Requisições' }}</a>
                                </li>
                    ...
                    @if (Auth::user()->role === 'admin')
                        {{-- =============================================== --}}
                        {{-- == INÍCIO DO NOVO MENU DE ENCOMENDAS (DESKTOP) == --}}
                        {{-- =============================================== --}}
                        <li>
                            <details>
                                <summary>🚚 Gestão de Encomendas</summary>
                                <ul class="p-2 bg-base-100 rounded-t-none z-[1]">
                                    <li>
                                    ...
                                    {{-- Podemos adicionar mais links aqui no futuro, como "Relatórios" --}}
                                </ul>
                            </details>
                        </li>
                        {{-- =============================================== --}}
