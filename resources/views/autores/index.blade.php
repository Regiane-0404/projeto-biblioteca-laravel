                ...
                <div class="card-body">
                    ...
                    <div class="stats stats-horizontal shadow mb-6">
                        ...
                        <div class="stat">
                            ...
                            <div class="stat-value text-sm">{{ $autores->firstItem() ?? 0 }} -
                                {{ $autores->lastItem() ?? 0 }}</div>
                        </div>
                    </div>
                        ...
                        <div class="flex justify-between items-center mb-4">
                            ...
                            <div class="dropdown dropdown-end">
                                ...
                                <ul tabindex="0"
                                    ...
                                    <li>
                                        <a
                                            href="{{ route('autores.index', array_merge(request()->query(), ['order_by' => 'nome', 'order_direction' => 'asc'])) }}">
                                            Nome A-Z
                                        </a>
                                    </li>
                                    <li>
                                        <a
                                            href="{{ route('autores.index', array_merge(request()->query(), ['order_by' => 'nome', 'order_direction' => 'desc'])) }}">
                                            Nome Z-A
                                        </a>
                                    </li>
                                    <li>
                                        <a
                                            href="{{ route('autores.index', array_merge(request()->query(), ['order_by' => 'created_at', 'order_direction' => 'desc'])) }}">
                                            Mais Recentes
                                        </a>
                                    </li>
                                    <li>
                                        <a
                                            href="{{ route('autores.index', array_merge(request()->query(), ['order_by' => 'created_at', 'order_direction' => 'asc'])) }}">
                                            Mais Antigos
                                        </a>
                                    </li>
                                </ul>
                            ...
                            @foreach ($autores as $autor)
                                <div
                                    ...
                                    <figure class="px-6 pt-6">
                                        ...
                                        @else
                                            <div
                                                class="w-24 h-24 bg-gradient-to-br from-secondary/20 to-accent/20 rounded-full flex items-center justify-center shadow-lg">
                                    ...
                                    <div class="card-body text-center p-4">
                                        ...
                                        <div class="text-sm text-base-content/60 mb-3">
                                            <p>{{ $autor->livros->count() }}
                                                {{ $autor->livros->count() === 1 ? 'livro' : 'livros' }}</p>
                    ...
                    @else
                        ...
                        <div class="text-center py-12">
                            ...
                            @else
                                ...
                                <a href="{{ route('autores.create') }}" class="btn btn-primary">➕ Adicionar Primeiro
                                    Autor</a>
                            @endif
                        </div>
                    @endif
